...
public class JpaDataFetcher implements DataFetcher {
	...
	public Object get(DataFetchingEnvironment environment) {
		...
		if (environment.getSource() != null) {
			...
			//this could cause inconsistent behaviour in the debugger if the debugger retrieves the attributes
	...
	protected Object convertValue(DataFetchingEnvironment environment, Argument argument, Value value) {
		if (value instanceof StringValue) {
			...
			//TODO: The UUID behaviour causes issues if you attempt to parse further down the hierarchy
